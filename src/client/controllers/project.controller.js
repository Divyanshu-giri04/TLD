// ---------------------------------------------------------------------------
// src/client/controllers/project.controller.js
// Client project applications, listing, and file upload.
// ---------------------------------------------------------------------------
...
class ProjectController {
  ...
  static async update(req, res) {
    try {
      const { title, description, department, status, assigned_crew, budget, timeline, start_date, end_date } = req.body;
      await getDatabase();
